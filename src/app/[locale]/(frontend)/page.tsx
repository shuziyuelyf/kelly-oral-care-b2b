        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-[#008FD5] hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/products" onClick={() => trackEvent('home_path_click', { path: 'ready_products' })} className="inline-flex items-center gap-2 text-[#008FD5] font-semibold group-hover:gap-3 transition-all">
                {t('readyCta')}
            ...
            <div className="group relative bg-[#173A63] rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <Link href="/private-label" onClick={() => trackEvent('home_path_click', { path: 'private_label' })} className="inline-flex items-center gap-2 text-white font-semibold group-hover:gap-3 transition-all">
                {t('plPathCta')}
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </Link>
            </div>
            ...
            <div className="group relative bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-[#173A63] hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/custom" onClick={() => trackEvent('home_path_click', { path: 'oem_odm' })} className="inline-flex items-center gap-2 text-[#173A63] font-semibold group-hover:gap-3 transition-all">
                {t('oemPathCta')}
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-6xl px-6">
              ...
              <div key={i} className="group bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    <Link href="/products" onClick={() => trackEvent('product_view', { product_id: `prod-${i}`, category: 'oral-care' })} className="flex-1 text-center py-2 text-sm font-medium text-[#173A63] border border-[#173A63] rounded-full hover:bg-[#173A63] hover:text-white transition-colors">
                      {t('viewDetails')}
                    </Link>
          ...
          <div className="text-center">
            <Link href="/products" className="inline-flex items-center gap-2 rounded-full bg-[#173A63] px-10 py-4 text-base font-semibold text-white hover:bg-[#1E4D7B] transition-colors">
              {t('viewAllProducts')}
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/custom" className="inline-flex items-center gap-2 rounded-full bg-[#173A63] px-10 py-4 text-base font-semibold text-white hover:bg-[#1E4D7B] transition-colors">
                  {t('oemSectionCta')}
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                </Link>
                <Link href="/custom#advanced" className="inline-flex items-center gap-2 rounded-full border-2 border-[#173A63] px-10 py-4 text-base font-semibold text-[#173A63] hover:bg-[#173A63] hover:text-white transition-colors">
                  {t('oemAdvancedCta')}
                </Link>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="group relative overflow-hidden rounded-3xl aspect-[4/3]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <Link href="/factory" className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors">
                  {t('fqFactoryCta')}
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                </Link>
              </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl aspect-[4/3]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <Link href="/quality" className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors">
                  {t('fqQualityCta')}
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                </Link>
              </div>
            ...
            {[
              ...
              <div key={i} className="group bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link href="/news" className="text-sm font-medium text-[#008FD5] hover:underline">{t('readMore')} →</Link>
                </div>
              </div>
            ))}
          </div>
