        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-[#008FD5] hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/products" className="inline-flex items-center gap-2 text-[#008FD5] font-semibold group-hover:gap-3 transition-all">
                {t('readyCta')}
            ...
            <div className="group relative bg-[#173A63] rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <Link href="/private-label" className="inline-flex items-center gap-2 text-white font-semibold group-hover:gap-3 transition-all">
                {t('plPathCta')}
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </Link>
            </div>
            ...
            <div className="group relative bg-white border-2 border-gray-100 rounded-3xl p-8 hover:border-[#173A63] hover:shadow-xl transition-all duration-300">
              ...
              <Link href="/custom" className="inline-flex items-center gap-2 text-[#173A63] font-semibold group-hover:gap-3 transition-all">
                {t('oemPathCta')}
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
              </Link>
            </div>
              ...
              <div key={i} className="group bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2">
                    <Link href="/products" className="flex-1 text-center py-2 text-sm font-medium text-[#173A63] border border-[#173A63] rounded-full hover:bg-[#173A63] hover:text-white transition-colors">
                      {t('viewDetails')}
                    </Link>
                    <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="flex-1 text-center py-2 text-sm font-medium text-white bg-[#21C96B] rounded-full hover:bg-[#1db85e] transition-colors">
                      WhatsApp
                    </a>
                  </div>
                </div>
