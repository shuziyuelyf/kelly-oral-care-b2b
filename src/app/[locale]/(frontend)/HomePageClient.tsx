        ...
        <div className="mx-auto w-[94%] max-w-[1360px] px-2 md:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            {hasWhatsApp && contact.whatsappUrl && (
              <a href={contact.whatsappUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('whatsapp_click', { page: 'home', position: 'final_cta' })} className="rounded-full bg-[#21C96B] px-10 py-4 text-base font-semibold text-white hover:bg-[#1db85e] transition-colors flex items-center gap-2">
