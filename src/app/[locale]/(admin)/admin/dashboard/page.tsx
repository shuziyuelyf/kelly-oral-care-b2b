  ...
  return (
    <div>
          ...
          <div key={i} className="bg-white rounded-lg p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#173A63] mt-1">{card.value}</p>
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        <div className="bg-white rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-orange-50 flex items-center justify-center"><MessageSquare className="w-5 h-5 text-[#008FD5]" /></div>
            <div><p className="text-sm text-gray-500">{t('todayInquiries')}</p><p className="text-xl font-bold text-[#173A63]">{stats.todayInquiries}</p></div>
          </div>
        </div>
        <div className="bg-white rounded-lg p-5 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-orange-50 flex items-center justify-center"><FileText className="w-5 h-5 text-[#008FD5]" /></div>
            <div><p className="text-sm text-gray-500">{t('todayCustomDemands')}</p><p className="text-xl font-bold text-[#173A63]">{stats.todayCustomDemands}</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-5 shadow-sm mb-8">
        <h3 className="font-semibold text-[#173A63] mb-4">{t('inquiryTrend')}</h3>
          ...
          {stats.inquiryTrend.map((item, i) => {
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <div className="w-full bg-[#008FD5]/20 rounded-t" style={{ height: `${height}%` }}>
                  <div className="w-full bg-[#008FD5] rounded-t" style={{ height: '100%' }} />
                </div>
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="p-5 border-b"><h3 className="font-semibold text-[#173A63]">{t('recentInquiries')}</h3></div>
